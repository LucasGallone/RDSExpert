...
- TMC Decoder / TMC Map: Added deactivation of the TMC map for encrypted services to prevent the display of incorrect locations.
...
- TMC Map: Fixed the interpretation of the "extent" values on the map.
...
- Improved country detection on the TMC Map.
...
- Fixed a PS display error in PDF exports, which occurred when no PS was decoded ("--------").
